...
const float speed_x_4265403241 = 0.1;
const float speed_y_4265403241 = 0.3;
...
float col_0(vec2 coord,float time) {
	...
	for (int i = 0; i < steps; i++)
	{
		...
		adjc.x += cos(theta)*time*speed + time * speed_x_4265403241;
		adjc.y -= sin(theta)*time*speed - time * speed_y_4265403241;
